...
```{r}
  ...
  box()
```
![](https://github.com/ipeaGIT/gtfs2gps/tree/master/man/figures/sao_gps60_sf.jpg)
...
![alt text](https://github.com/ipeaGIT/gtfs2gps/tree/master/man/figures/speed.PNG "Logo Title Text 1")
