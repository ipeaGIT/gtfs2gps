...
date: "`r format('16 September 2019')`"
urlcolor: blue
output:
  pdf_document:
    fig_caption: yes
...
sp_small <- gtfs2gps::filter_by_shape_id(sp, 53000:55000)
...
To convert GTFS to GPS format, use `gtfs2gps()`. [...] This function takes time to run.
